...
const SEARCHES = [
  'jak zainstalować avast',
  'lubiekotki',
  'słodkie zdjęcia kotków',
  'meow',
  'izrael'
]
...
const LOGOUT_SITES = {
  ...
  Twitch: ['GET', 'https://passport.twitch.tv/logout/new'],
  Canva: ['POST', 'https://www.canva.com/_ajax/auth/session/logout', {}],
  Notion: ['POST', 'https://www.notion.so/logout', {}],
  Udemy: ['GET', 'https://www.udemy.com/join/logout/'],
  Medium: ['GET', 'https://medium.com/m/signout?redirectUrl=/'],
  Fiverr: ['GET', 'https://www.fiverr.com/users/logout'],
  Behance: ['POST', 'https://www.behance.net/logout', {}, {'x-csrf-token': 'TOKEN_CSRF'}],
  Quora: ['GET', 'https://www.quora.com/logout'],
  Shutterstock: ['GET', 'https://www.shutterstock.com/logout'],
  Glassdoor: ['GET', 'https://www.glassdoor.com/member/logout.htm'],
  KhanAcademy: ['GET', 'https://www.khanacademy.org/logout'],
  Udacity: ['GET', 'https://classroom.udacity.com/logout'],
  ...
  Millennium: ['GET', 'https://www.bankmillennium.pl/pl/logout/'],
  Alior: ['GET', 'https://www.aliorbank.pl/logout'],
  PekaoSA: ['POST', 'https://www.pekao24.pl/api/authentication/customer/logout', {}],
  VeloBank: ['GET', 'https://www.velobank.pl/wyloguj'],
  NestBank: ['GET', 'https://www.nestbank.pl/logout'],
  BOŚ: ['GET', 'https://www.bosbank.pl/logout'],
